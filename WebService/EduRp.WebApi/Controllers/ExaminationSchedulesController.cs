...
namespace EduRp.WebApi.Controllers
{
    public class ExaminationSchedulesController : ApiController
    {
        ...
        public IHttpActionResult UpdateExaminationScheduleDetail(ClassRoomStaffAssociationModel classroomstaffAssociation)
        {
            var isUpdate = examinationschedulesService.UpdateExaminationScheduleDetail(classroomstaffAssociation.UniversityId, classroomstaffAssociation);
            if (isUpdate == true)
                return Ok();
